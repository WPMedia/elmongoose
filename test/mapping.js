...
describe('elmongo mapping tests', function () {
  ...
  it('generates correct mapping for Cats model', function (done) {
    ...
    assert.equal(generatedMap.properties.nicknames.analyzer, 'autocomplete_index')
  ...
  it('generates correct mapping for Hetero model', function (done) {
    ...
    assert(generatedMap.properties.id)
    assert.equal(generatedMap.properties.id.type, 'string')
