 ...
 *
 */
describe('elmongoose plugin', function () {
  ...
  //
	...
	// })
  //
	// it('elmongoose.search() with * should return all results', function (done) {
	// 	elmongoose.search({ query: '*', collections: [ 'cats' ] }, function (err, results) {
	// 		testHelper.assertErrNull(err)
  //
	// 		assert.equal(results.total, testCats.length)
	// 		assert.equal(results.hits.length, testCats.length)
  //
	...
	// })
  //
	// it('elmongoose.search.config() then elmongoose.search with * should return all results', function (done) {
  ...
  //
	...
	// })
  //
	// it('Model.search() w/ fields returns the exact match', function testMatchPhrase(done) {
	// 	models.Cat.search({ mustMatchPhrase: { name: 'Puffy' } }, function(err, results) {
	// 		testHelper.assertErrNull(err);
