  ...
  it('insert 10 cats into the DB, reindexing while searching should keep returning results', function (done) {
    ...
    async.series({
      ...
      reindexWhileSearching: function (next) {
        ...
        // TODO: does not reinidex, instead will create a new index of the same name for Cat.
        // models.Cat.resync('resync_cat', function(err) {
        //   if (err)
        //     next(err);
        // });
